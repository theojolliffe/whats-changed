...
<script>
  ...
  export let yAxis = true;
	...
	export let colors = color ? [color] : ['#206095', '#27A0CC', '#A8BD3A', '#003C57', '#118C7B', '#F66068', '#746CB1', '#22D0B6', 'lightgrey'];
...
<div class="chart-container" style="height: {typeof height == 'number' ? height + 'px' : height }">
	...
	>
      ...
      {/if}
      {#if yAxis}
			  <AxisY ticks={yTicks} formatTick={yFormatTick} prefix={yPrefix} suffix={"%"}/>
      {/if}
